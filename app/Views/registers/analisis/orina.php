            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    if (in_array($valNorm, ['positivo', 'reactivo'], true)) {
                        ...
                        $min = $item->valor_min ?? '';
                        $max = $item->valor_max ?? '';
                        if ($val !== '-' && $min !== '' && $max !== '' && is_numeric($val) && is_numeric($min) && is_numeric($max)) {
                            $class = ($val >= $min && $val <= $max) ? 'normal' : 'text-danger font-weight-bold';
                        } else {
                            $class = 'normal';
                        }
                    }
                    ...
                    <?php if (is_object($item)): ?>
                        <tr>
                            ...
                            <td class="text-center <?= $class ?>"><?= esc($val) ?></td>
