...
<div class="row">
    ...
    <div class="col-12">
        <div class="mb-3">
            <label for="monto_pagar" class="form-label">Monto a pagar: <span class="text-danger">*</span></label>
            <input type="text" name="monto_pagar" id="monto_pagar" class="form-control" value="" required>
