...
$areaSepBg = ! empty($areaSepStyle['bg_transparent']) ? 'transparent' : (string) $areaSepStyle['bg_color'];
...
$areaSepShadow = $segShadowMap[$areaSepStyle['shadow'] ?? 'none'] ?? 'none';
$rsTextShadowMap = [
    'none'   => 'none',
    'soft'   => '0.4px 0.4px 1px rgba(0,0,0,0.28)',
    'medium' => '0.7px 0.7px 1.4px rgba(0,0,0,0.35)',
...
:root {
    ...
    --pdf-grupo-area-separator-bg: <?= esc($areaSepBg) ?>;
    --pdf-grupo-area-separator-border: <?= esc((string) $areaSepStyle['border_color']) ?>;
    --pdf-grupo-area-separator-border-width: <?= esc((string) $areaSepStyle['border_width_px']) ?>px;
    --pdf-grupo-area-separator-line-color: <?= esc((string) $areaSepStyle['line_color']) ?>;
    --pdf-grupo-area-separator-line-width: <?= esc((string) $areaSepStyle['line_width_px']) ?>px;
    --pdf-grupo-area-separator-shadow: <?= esc($areaSepShadow) ?>;
    --pdf-grupo-area-separator-font-family: "<?= esc((string) $areaSepStyle['font_family']) ?>";
    --pdf-grupo-area-separator-font-size: <?= esc((string) $areaSepStyle['font_size_pt']) ?>pt;
    --pdf-grupo-area-separator-font-weight: <?= esc((string) $areaSepStyle['font_weight']) ?>;
    --pdf-grupo-area-separator-text-color: <?= esc((string) $areaSepStyle['text_color']) ?>;
    --pdf-grupo-area-separator-font-style: <?= esc((string) $areaSepStyle['font_style']) ?>;
    --pdf-grupo-area-separator-transform: <?= esc((string) $areaSepStyle['text_transform']) ?>;
    ...
    --pdf-results-hdr-analisis-align: <?= esc((string) ($rs['results_hdr_analisis_align'] ?? 'left')) ?>;
    --pdf-results-col-analisis-align: <?= esc((string) ($rs['results_col_analisis_align'] ?? 'left')) ?>;
    --pdf-results-hdr-resultado-align: <?= esc((string) ($rs['results_hdr_resultado_align'] ?? 'center')) ?>;
    --pdf-results-col-resultado-align: <?= esc((string) ($rs['results_col_resultado_align'] ?? 'center')) ?>;
    --pdf-results-hdr-rango-align: <?= esc((string) ($rs['results_hdr_rango_align'] ?? 'center')) ?>;
    --pdf-results-col-rango-align: <?= esc((string) ($rs['results_col_rango_align'] ?? 'center')) ?>;
    --pdf-results-hdr-interpretacion-align: <?= esc((string) ($rs['results_hdr_interpretacion_align'] ?? 'center')) ?>;
    --pdf-results-col-interpretacion-align: <?= esc((string) ($rs['results_col_interpretacion_align'] ?? 'center')) ?>;
}
table.results {
