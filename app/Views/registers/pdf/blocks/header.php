...
[$n, $buckets] = \App\Services\ReportPdfLayoutService::columnBucketsForSection($layout, 'header');
$n             = max(1, $n);
...
<div class="header header-grid">
    <?php for ($c = 0; $c < $n; $c++):
        ...
        ?>
    <div class="header-col header-col-<?= $c ?>" style="width: <?= $pct ?>%; text-align: <?= esc($align) ?>;">
