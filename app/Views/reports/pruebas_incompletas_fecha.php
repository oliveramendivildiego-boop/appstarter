...
<form method="get" action="<?= site_url('reports/pruebasIncompletasFecha') ?>" class="row g-3 mb-4 d-print-none">
    <div class="col-auto">
...
<?= view('reports/partials/report_actions', [
    'pdf_url' => site_url('reports/pruebasIncompletasFechaPdf?' . http_build_query(['start' => $startDate ?? '', 'end' => $endDate ?? ''])),
]) ?>
