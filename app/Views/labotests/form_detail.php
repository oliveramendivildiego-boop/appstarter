...
<nav id="labotests-scroll-nav" class="labotests-scroll-nav" aria-label="Navegación rápida de página" hidden>
    <button type="button" class="labotests-scroll-nav__btn" data-scroll-target="top" title="Ir arriba" aria-label="Ir arriba">
        <i class="fa-solid fa-chevron-up" aria-hidden="true"></i>
    </button>
    <button type="button" class="labotests-scroll-nav__btn" data-scroll-target="middle" title="Ir al medio" aria-label="Ir al medio">
        <i class="fa-solid fa-grip-lines" aria-hidden="true"></i>
    </button>
    <button type="button" class="labotests-scroll-nav__btn" data-scroll-target="bottom" title="Ir abajo" aria-label="Ir abajo">
        <i class="fa-solid fa-chevron-down" aria-hidden="true"></i>
    </button>
</nav>
<script>
(function() {
    var nav = document.getElementById('labotests-scroll-nav');
    if (!nav) return;
