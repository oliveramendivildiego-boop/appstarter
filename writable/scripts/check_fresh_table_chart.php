...
(new \App\Services\Report\ReportDataCacheService())->clear($id);
...
echo "FRESH render registro $id\n";
echo "modo: " . json_encode($data['report_graficar_modo'] ?? []) . "\n";
echo "tabla: " . ($hasTable ? 'SI' : 'NO') . "\n";
echo "grafica: " . ($hasChart ? 'SI' : 'NO') . "\n";
