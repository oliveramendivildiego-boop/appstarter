...
echo 'block len: ' . strlen($block) . PHP_EOL;
echo 'HEMOGRAMA count: ' . substr_count($block, 'HEMOGRAMA') . PHP_EOL;

$doc = '<!DOCTYPE html><html><head>' . $head . '</head><body class="pdf-layout-engine pdf-dompdf-download pdf-engine-mpdf">' . $block . '</body></html>';
...
$out = WRITEPATH . 'cache/full_first_block_308.pdf';
